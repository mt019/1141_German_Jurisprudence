...
II. Die Scheindogmatik der mittelbaren Drittwirkung

**翻譯**：間接第三人效力的「偽」釋義學（相對於真正能提供操作標準的教義，*Scheindogmatik* 指看似完備、實則無法發揮效力的「表面釋義學」）【沒有真正的直指核心的釋義學的發展】。
...
後續論證的出發點是這樣一個乍看之下令人驚訝的結論：在私法領域，關於基本權間接第三人效力的傳統釋義學是**無效的**。
...
| *Dogmatik* | **die Dogmatik** | 陰 | 單 | 主格 | 釋義學、教義體系 |
...
所謂「無效」，意思是：它**未能勝任**釋義學通常應承擔的任務——亦即以**概念**與**目的論**方式透徹處理法律問題，使其得以在**法律確定**且**理由透明**的條件下作出決定。
...
- *durchdringen*（Akk.）：徹底理解、貫穿 
  - gründlich studieren und verstehen 
...
| *Dogmatik* | **die Dogmatik** | 陰 | 單 | 主格（Sie=指代） | 釋義學 |
...
- *rechtssicher*（具法律確定性）
- *begründungstransparent*（具理由透明性【理由可供檢驗的】）

### **3. 法學背景**
#### **3.1 Rn. 5.2 的核心主題**
界定「釋義學有效性」的判準：可操作、可預測、可理由化。
...
理想情況下，成功運作的法律釋義學應促成**理論範疇**與**實務結果**的收斂，並由此為**未來的法律發展**創造**可預測性**與**法律確定性**。

### **1. 句子結構解析**

- **狀語（方式）**：*Idealerweise*
- **主語**：*gelingende Rechtsdogmatik*（分詞作定語，表示「能奏效的」）
  - 改寫成關係子句：*Rechtsdogmatik, die gelingt*（以動詞 *gelingen* 直陳式現在時表「能成功運作的法律釋義學」）。
- **並列謂語**：  
  - *führt … zu*（導致、通向 + Dat.）  
  - *schafft*（創造）
- **補語與受詞**：
  ...
  - *dadurch*（因果銜接副詞）
  - *Berechenbarkeit und Rechtssicherheit*（schaffen 的直接受詞，並列）
...
| 變格形式 | 原形（主格+定冠） | 性 | 數 | 格 | 解釋 |
|---|---|---|---|---|---|
| *Rechtsdogmatik* | **die Rechtsdogmatik** | 陰 | 單 | 主格 | 法律釋義學 |
...
- **主句**
  - **主語**：*All dies*
    - 指涉前段所述的成果：
      - *Konvergenz von theoretischen Kategorien und praktischen Ergebnissen*（理論範疇與實務結果的匯合收斂）
      - 以及 *Berechenbarkeit und Rechtssicherheit für die künftige Rechtsentwicklung*（為未來法律發展提供可預測性與法律確定性）。
...
- **結果從句（dass …）**
  - **主語**：*die Frage*
  - **介詞補語**：*nach den tieferen Ursachen und daraus folgenden Richtungsentscheidungen*
    - *nach* + Dat. 複數；
    - *daraus* = *aus den tieferen Ursachen*，指「由此（更深層原因）所衍生」
